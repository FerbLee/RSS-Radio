...
Os superusuarios do sistema, pola súa parte, poden editar e borrar calquer contido mediante ferramentas de Django coma panel de administración ou o IPython shell.
